...
if ($_POST) {
  ...
  $sentencia = $conexion->prepare("INSERT INTO `tbl_empleados` (`id`, `primernombre`, `segundonombre`, `primerapellido`, `segundoapellido`, `foto`, `cv`, `idpuesto`, `fechadeingreso`) VALUES (NULL,:primernombre ,:segundonombre,:primerapellido,:segundoapellido,:foto,:cv,:idpuesto,:fechadeingreso);");
  ...
  $nombrearchivofoto = ($foto != "") ? $fechafoto->getTimestamp() . "_" . $_FILES['foto']['name'] : "";
  ...
  $fechacv = new DateTime();
  $nombrearchivo_cv = ($cv != "") ? $fechacv->getTimestamp() . "_" . $_FILES['cv']['name'] : "";
